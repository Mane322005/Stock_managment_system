...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['delete_id'])) {
    ...
    echo "<script>alert('Category deleted successfully!'); window.location.href='categorydelete.php';</script>";
}
?>
...
<head>
    ...
    <link rel="stylesheet" href="styles.css"> <!-- Ensure your styles are consistent -->
    <style>
        .container {
            max-width: 1000px;
            margin: auto;
